...
>> PERSONAL_USE, coordinates will need to be updated depending on some variables
>> variables -- the size of the monitor, window-mode size of the game etc.
...
###########################################
print("--> [Portrait percentage] running...\n")
